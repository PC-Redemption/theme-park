...
Mission Control Static is the framework-neutral starter implementation in this repo.
...
```bash
python3 sites/mission-control-static/preview.py
```

Then open:

```text
http://127.0.0.1:8000/sites/mission-control-static/templates/index.html
```
